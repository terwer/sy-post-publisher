    ...
    <el-header id="publisher-header">
      <div v-if="!showTitle">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--open" type="success" @click="handleWinOpen">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--preview" type="success" @click="handleWinPreview">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--preview" type="success" @click="handleWinManage">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--anki" type="success" @click="handleWinAnki">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--picture" type="success" @click="handleWinPicture">
        ...
        <el-tooltip
          ...
          popper-class="publish-menu-tooltip"
        >
          <el-button v-if="showOpenBtn" class="b3-button--picture" type="success" @click="handleWinSet">
        ...
        -->
        <el-button v-if="showCloseBtn" class="b3-button--cancel" type="danger" @click="handleWinClose">
          <font-awesome-icon icon="fa-solid fa-xmark" />
        </el-button>
      </div>

      <h1 v-if="showTitle" class="header-title-default">
        <el-button class="header-title-btn disabled-click"> 思源笔记发布工具 </el-button>
      </h1>
    </el-header>
  </div>
</template>
