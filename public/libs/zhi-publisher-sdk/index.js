...
(function(n, t) {
  !n || n.getElementById("livereloadscript") || (t = n.createElement("script"), t.async = 1, t.src = "//" + (self.location.host || "localhost").split(":")[0] + ":35730/livereload.js?snipver=1", t.id = "livereloadscript", n.getElementsByTagName("head")[0].appendChild(t));
})(self.document);
class a {
  static init(t) {
  ...
  static blogApi(t, s) {
    if (!this.bApi) {
      let e, o;
      switch (console.log(t instanceof this.Env), t instanceof this.Env && (o = t.getEnv(this.BlogConstants.DEFAULT_BLOG_TYPE_KEY)), o) {
        case this.BlogTypeEnum.BlogTypeEnum_Wordpress:
          break;
        default: {
          if (t instanceof this.Env) {
            const p = t.getEnvOrDefault(this.SiyuanConstants.VITE_SIYUAN_API_URL_KEY, "http://127.0.0.1:6806"), l = t.getStringEnv(this.SiyuanConstants.VITE_SIYUAN_AUTH_TOKEN_KEY), c = new this.SiyuanConfig(p, l);
            c.fixTitle = !0, e = new this.SiYuanApiAdaptor(c);
          } else
