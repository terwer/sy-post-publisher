...
var x = /* @__PURE__ */ ((e) => (e.LOG_LEVEL_TRACE = "TRACE", e.LOG_LEVEL_DEBUG = "DEBUG", e.LOG_LEVEL_INFO = "INFO", e.LOG_LEVEL_WARN = "WARN", e.LOG_LEVEL_ERROR = "ERROR", e))(x || {}), ee = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Y(e) {
...
class V {
  ...
  static getEnvLevel(r) {
    ...
    let t;
    try {
      t = r.getEnvOrDefault(D.LOG_LEVEL_KEY, x.LOG_LEVEL_INFO);
    } catch {
      t = x.LOG_LEVEL_INFO;
    }
    const o = V.stringToEnumValue(x, t.toUpperCase());
...
const S = class {
  ...
  static isInChromeExtension() {
    return S.isInBrowser ? window.location.href.indexOf("chrome-extension://") > -1 : !1;
  }
};
let p = S;
...
* 是否是Electron环境
*/
E(p, "isElectron", () => !S.isInBrowser || !window.navigator || !window.navigator.userAgent ? !1 : /Electron/.test(window.navigator.userAgent)), /**
* 是否有Node环境，目前包括 Electron 和 Node
*/
E(p, "hasNodeEnv", () => S.isElectron() || S.isNode), /**
* 获取url参数
*
* @param sParam - 参数
*/
...
E(p, "setUrlParameter", (e, r, t) => {
  if (e.includes(r))
    return S.replaceUrlParam(e, r, t);
  const o = e.split("#");
  let n = o[0];
  const i = o[1];
...
E(p, "reloadTabPage", (e, r = 200) => {
  setTimeout(function() {
    if (S.isInBrowser) {
      ...
      window.location.href = S.setUrlParameter(t, "tab", e);
    }
  }, r);
}), /**
* 刷新当前tab页面
...
class Le {
  constructor(r, t, o) {
    ...
    this.stackSize = 1;
    let n;
    r ? n = r : n = V.getEnvLevel(o), n = n ?? x.LOG_LEVEL_INFO, W.setLevel(n);
    const i = (s, u, g, c) => {
      ...
      format(s, u, g) {
        ...
        switch (s) {
          ...
          case x.LOG_LEVEL_ERROR:
            ...
            break;
          default:
            c = i(x.LOG_LEVEL_INFO, a, g, O.green);
            break;
        }
        return c.join(" ");
      }
