...
var zt = { exports: {} }, Sn = {}, qe = {}, Rr = {}, et = {}, se = {}, xr = {};
(function(e) {
...
const Fe = se, Zd = tt, hr = Qe, He = ke, Qa = ie, Yd = qe;
class Tt {
  constructor(r) {
    var n;
...
function Xt(e) {
  ...
  if (r)
    return r;
  const n = (0, He.getFullPath)(this.opts.uriResolver, e.root.baseId), { es5: a, lines: u } = this.opts.code, { ownProperties: o } = this.opts, p = new Fe.CodeGen(this.scope, { es5: a, lines: u, ownProperties: o });
  let y;
  ...
  const v = {
    ...
    topSchemaRef: p.scopeValue("schema", this.opts.code.source === !0 ? { ref: e.schema, code: (0, Fe.stringify)(e.schema) } : { ref: e.schema }),
    validateName: b,
    ValidationError: y,
    schema: e.schema,
    schemaEnv: e,
  ...
  try {
    ...
    if (this.scope.value(b, { ref: L }), L.errors = null, L.schema = e.schema, L.schemaEnv = e, e.$async && (L.$async = !0), this.opts.code.source === !0 && (L.source = { validateName: b, validateCode: S, scopeValues: p._values }), this.opts.unevaluated) {
      ...
      L.evaluated = {
        props: R instanceof Fe.Name ? void 0 : R,
        items: j instanceof Fe.Name ? void 0 : j,
        dynamicProps: R instanceof Fe.Name,
        dynamicItems: j instanceof Fe.Name
      }, L.source && (L.source.evaluated = (0, Fe.stringify)(L.evaluated));
    }
...
function Xd(e, r, n) {
  var a;
  n = (0, He.resolveUrl)(this.opts.uriResolver, r, n);
  const u = e.refs[n];
  if (u)
    return u;
...
Re.resolveRef = Xd;
function Qd(e) {
  return (0, He.inlineRef)(e.schema, this.opts.inlineRefs) ? e.schema : e.validate ? e : Xt.call(this, e);
}
function Yn(e) {
...
function jt(e, r) {
  const n = this.opts.uriResolver.parse(r), a = (0, He._getFullPath)(this.opts.uriResolver, n);
  let u = (0, He.getFullPath)(this.opts.uriResolver, e.baseId, void 0);
  if (Object.keys(e.schema).length > 0 && a === u)
    return It.call(this, n, e);
  const o = (0, He.normalizeId)(a), p = this.refs[o] || this.schemas[o];
  if (typeof p == "string") {
  ...
  if (typeof (p == null ? void 0 : p.schema) == "object") {
    if (p.validate || Xt.call(this, p), o === (0, He.normalizeId)(r)) {
      const { schema: y } = p, { schemaId: b } = this.opts, v = y[b];
      return v && (u = (0, He.resolveUrl)(this.opts.uriResolver, u, v)), new Tt({ schema: y, schemaId: b, root: e, baseId: u });
    }
...
function It(e, { baseId: r, schema: n, root: a }) {
  ...
  for (const y of e.fragment.slice(1).split("/")) {
    ...
    !ru.has(y) && v && (r = (0, He.resolveUrl)(this.opts.uriResolver, r, v));
  }
  let o;
  if (typeof n != "boolean" && n.$ref && !(0, Qa.schemaHasRulesButRef)(n, this.RULES)) {
    const y = (0, He.resolveUrl)(this.opts.uriResolver, r, n.$ref);
    o = jt.call(this, a, y);
  }
...
(function(e, r) {
  (function(n, a) {
    ...
    function v(E) {
      ...
      var ce = u(u("25[0-5]") + "|" + u("2[0-4]" + P) + "|" + u("1" + P + P) + "|" + u("0?[1-9]" + P) + "|0?0?" + P), ve = u(ce + "\\." + ce + "\\." + ce + "\\." + ce), ee = u(M + "{1,4}"), me = u(u(ee + "\\:" + ee) + "|" + ve), we = u(u(ee + "\\:") + "{6}" + me), ge = u("\\:\\:" + u(ee + "\\:") + "{5}" + me), ar = u(u(ee) + "?\\:\\:" + u(ee + "\\:") + "{4}" + me), We = u(u(u(ee + "\\:") + "{0,1}" + ee) + "?\\:\\:" + u(ee + "\\:") + "{3}" + me), Je = u(u(u(ee + "\\:") + "{0,2}" + ee) + "?\\:\\:" + u(ee + "\\:") + "{2}" + me), Pr = u(u(u(ee + "\\:") + "{0,3}" + ee) + "?\\:\\:" + ee + "\\:" + me), lr = u(u(u(ee + "\\:") + "{0,4}" + ee) + "?\\:\\:" + me), Me = u(u(u(ee + "\\:") + "{0,5}" + ee) + "?\\:\\:" + ee), Ze = u(u(u(ee + "\\:") + "{0,6}" + ee) + "?\\:\\:"), fr = u([we, ge, ar, We, Je, Pr, lr, Me, Ze].join("|")), er = u(u(de + "|" + A) + "+");
    ...
    var J = function(f) {
      ...
      for (ee && P.push(s); me < M; ) {
        var we = R, ge = !0, ar = !1, We = void 0;
        try {
          for (var Je = f[Symbol.iterator](), Pr; !(ge = (Pr = Je.next()).done); ge = !0) {
            var lr = Pr.value;
            lr >= A && lr < we && (we = lr);
          }
        } catch (qr) {
        ...
        var Ze = !0, fr = !1, er = void 0;
        try {
          for (var Hr = f[Symbol.iterator](), Ba; !(Ze = (Ba = Hr.next()).done); Ze = !0) {
            var Ha = Ba.value;
    ...
    function xe(E, f) {
      ...
      if (A) {
        ...
        var ar = we.reduce(function(Me, Ze, fr) {
          if (!Ze || Ze === "0") {
            var er = Me[Me.length - 1];
            er && er.index + er.length === fr ? er.length++ : Me.push({ index: fr, length: 1 });
          }
          return Me;
        }, []), We = ar.sort(function(Me, Ze) {
          return Ze.length - Me.length;
        })[0], Je = void 0;
        if (We && We.length > 1) {
          var Pr = we.slice(0, We.index), lr = we.slice(We.index + We.length);
          Je = Pr.join(":") + "::" + lr.join(":");
        } else
          Je = we.join(":");
        return X && (Je += "%" + X), Je;
    ...
    function je(E) {
      ...
      if (X !== void 0 && (f.reference !== "suffix" && M.push("//"), M.push(X), E.path && E.path.charAt(0) !== "/" && M.push("/")), E.path !== void 0) {
        var Q = E.path;
        !f.absolutePath && (!A || !A.absolutePath) && (Q = Ge(Q)), X === void 0 && (Q = Q.replace(/^\/\//, "/%2F")), M.push(Q);
      }
    ...
    }, _s = {}, La = "[A-Za-z0-9\\-\\.\\_\\~\\xA0-\\u200D\\u2010-\\u2029\\u202F-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]", Ke = "[0-9A-Fa-f]", vs = u(u("%[EFef]" + Ke + "%" + Ke + Ke + "%" + Ke + Ke) + "|" + u("%[89A-Fa-f]" + Ke + "%" + Ke + Ke) + "|" + u("%" + Ke + Ke)), ys = "[A-Za-z0-9\\!\\$\\%\\'\\*\\+\\-\\^\\_\\`\\{\\|\\}\\~]", ws = "[\\!\\$\\%\\'\\(\\)\\*\\+\\,\\-\\.0-9\\<\\>A-Z\\x5E-\\x7E]", bs = a(ws, '[\\"\\\\]'), $s = "[\\!\\$\\'\\(\\)\\*\\+\\,\\;\\:\\@]", Es = new RegExp(La, "g"), kr = new RegExp(vs, "g"), ks = new RegExp(a("[^]", ys, "[\\.]", '[\\"]', bs), "g"), za = new RegExp(a("[^]", La, $s), "g"), Ps = za;
    function Nt(E) {
      var f = re(E);
...
(function(e) {
  ...
  function D(B) {
    var k, F, N, l, w, I, K, W, re, ae, fe, Te, xe, Dr, Lr, Ae, zr, wr, br, $r, Vr, Ge, je, Er, Fr;
    ...
    return {
      ...
      validateSchema: (Ge = B.validateSchema) !== null && Ge !== void 0 ? Ge : !0,
...
const lt = ne, Ue = se, yi = Qe, ft = ie, wi = {
  ...
  code(e) {
    ...
    S(), e.ok((0, Ue._)`${o} === ${yi.default.errors}`);
    function S() {
      r.forIn("key", u, (T) => {
    ...
    function z(T) {
      ...
      if (v.length > 8) {
        ...
        v.length ? $ = (0, Ue.or)(...v.map((O) => (0, Ue._)`${T} === ${O}`)) : $ = Ue.nil;
      return g.length && ($ = (0, Ue.or)($, ...g.map((O) => (0, Ue._)`${(0, lt.usePattern)(e, O)}.test(${T})`))), (0, Ue.not)($);
    }
    function L(T) {
      r.code((0, Ue._)`delete ${u}[${T}]`);
    }
    function R(T) {
      ...
      if (typeof n == "object" && !(0, ft.alwaysValidSchema)(p, n)) {
        const $ = r.name("valid");
        b.removeAdditional === "failing" ? (j(T, $, !1), r.if((0, Ue.not)($), () => {
          e.reset(), L(T);
        })) : (j(T, $), y || r.if((0, Ue.not)($), () => r.break()));
      }
    }
    function j(T, $, O) {
      const D = {
...
const $i = qe, an = ne, Dt = ie, nn = Ot, Ei = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
...
var Ve = /* @__PURE__ */ ((e) => (e.LOG_LEVEL_TRACE = "TRACE", e.LOG_LEVEL_DEBUG = "DEBUG", e.LOG_LEVEL_INFO = "INFO", e.LOG_LEVEL_WARN = "WARN", e.LOG_LEVEL_ERROR = "ERROR", e))(Ve || {}), us = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Oa(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var is = { exports: {} };
...
class St {
  ...
  static getEnvLevel(r) {
    ...
    let n;
    try {
      n = r.getEnvOrDefault(Pt.LOG_LEVEL_KEY, Ve.LOG_LEVEL_INFO);
    } catch {
      n = Ve.LOG_LEVEL_INFO;
    }
    const a = St.stringToEnumValue(Ve, n.toUpperCase());
...
const Be = class {
  ...
  static isInChromeExtension() {
    return Be.isInBrowser ? window.location.href.indexOf("chrome-extension://") > -1 : !1;
  }
};
let oe = Be;
...
* 是否是Electron环境
*/
$e(oe, "isElectron", () => !Be.isInBrowser || !window.navigator || !window.navigator.userAgent ? !1 : /Electron/.test(window.navigator.userAgent)), /**
* 是否有Node环境，目前包括 Electron 和 Node
*/
$e(oe, "hasNodeEnv", () => Be.isElectron() || Be.isNode), /**
* 获取url参数
*
* @param sParam - 参数
*/
...
$e(oe, "setUrlParameter", (e, r, n) => {
  if (e.includes(r))
    return Be.replaceUrlParam(e, r, n);
  const a = e.split("#");
  let u = a[0];
  const o = a[1];
...
$e(oe, "reloadTabPage", (e, r = 200) => {
  setTimeout(function() {
    if (Be.isInBrowser) {
      ...
      window.location.href = Be.setUrlParameter(n, "tab", e);
    }
  }, r);
}), /**
* 刷新当前tab页面
...
$e(oe, "reloadPage", () => {
  setTimeout(function() {
    Be.isInBrowser && window.location.reload();
  }, 200);
}), /**
* 刷新当前tab页面
*
...
class Ko {
  constructor(r, n, a) {
    ...
    let u;
    r ? u = r : u = St.getEnvLevel(a), u = u ?? Ve.LOG_LEVEL_INFO, pt.setLevel(u);
    const o = (p, y, b, v) => {
      ...
      format(p, y, b) {
        ...
        switch (p) {
          ...
          case Ve.LOG_LEVEL_ERROR:
            ...
            break;
          default:
            v = o(Ve.LOG_LEVEL_INFO, g, b, Le.green);
            break;
        }
        return v.join(" ");
      }
