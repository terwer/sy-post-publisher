 ...
 * Hexo平台的YAML解析器
 */
export class HexoYamlConverterAdaptor extends YamlConvertAdaptor implements IYamlConvertAdaptor {
  private readonly logger = LogFactory.getLogger("utils/platform/github/hexo/hexoYamlConverterAdaptor.ts")
