...
import { getSiyuanNewWinPageId, isInSiyuanNewWinBrowser } from "~/utils/otherlib/siyuanBrowserUtil"
 ...
 */
export const getPageId = async (force?: boolean, pageId?: string): Promise<any> => {
  let syPageId
