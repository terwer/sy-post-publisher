 ...
 * @param subtype
 */
const genNewPlatform = (ptype: PlatformType, platformKey: string, platformName: string, subtype?: SubPlatformType) => {
 ...
 */
const doFixPlatformInfo = (pkey: string, dynamicConfigArray: DynamicConfig[]) => {
