...
import { getDynamicJsonCfg, getDynSwitchKey } from "~/utils/platform/dynamicConfig"
...
export const getPublishCfg = (): PublishPreference => {
  let publishCfg = getJSONConf<PublishPreference>(CONSTANTS.PUBLISH_PREFERENCE_CONFIG_KEY)
