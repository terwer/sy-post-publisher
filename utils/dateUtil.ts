 ...
 * @returns {string|*}
 */
export const formatIsoToNumDate = (str: string, isAddTimeZone?: boolean): string => {
  if (!str) {
    return ""
  }
  let newstr = str
 ...
 * @returns {string|*}
 */
export const formatIsoToZhDate = (str: string, isAddTimeZone?: boolean, isShort?: boolean): string => {
  if (!str) {
    return ""
  }
  let newstr = str
