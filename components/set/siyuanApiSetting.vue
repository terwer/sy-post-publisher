  ...
  <div>
    <el-form ref="siyuanApiSettingFormRef" :model="siyuanApiChangeForm" :rules="siyuanApiChangeRules">
      ...
      <div class="dialog-action">
        <el-form-item>
          <el-button @click="handleCancel" v-if="props.showCancel">{{ $t("main.opt.cancel") }} </el-button>
          <el-button type="primary" @click="handleOk(siyuanApiSettingFormRef)">{{ $t("main.opt.ok") }} </el-button>
        </el-form-item>
      </div>
    </el-form>
  </div>
