...
<template>
  <div class="anki-body">
    <el-alert
      ...
      :closable="false"
    />
    <el-button type="primary" @click="updateCard" :loading="isAnkiLoading" v-if="isInSiyuanNewWinBrowser()"
      >更新卡片
    </el-button>
    <el-row :gutter="12">
      <el-col v-for="(o, index) in formData.ankiInfo" :key="o.id" :span="8" class="anki-card-col">
        <el-card shadow="always">
          <div class="block-title">{{ index }}.{{ o.content }} - {{ o.id }}</div>
          <div class="anki-option">
            ...
            <div class="anki-deck">
              <el-form-item :label="$t('anki.siyuan.deck')">
                ...
                />
                <el-button v-else class="button-new-tag ml-1 el-tag" size="small" @click="deckShowInput(o.id)">
            ...
            <div class="anki-tags">
              <el-form-item :label="$t('anki.siyuan.tag')">
                ...
                />
                <el-button v-else class="button-new-tag ml-1 el-tag" size="small" @click="tagShowInput(o.id)">
            ...
            -->
            <el-button type="primary" class="button" :data-block-id="o.id" @click="saveAnkiInfo(o.id)"
              >保存Anki标记
            </el-button>
          </div>
        </el-card>
...
import { getSiyuanNewWinDataDir, isInSiyuanNewWinBrowser } from "~/utils/otherlib/siyuanBrowserUtil"
