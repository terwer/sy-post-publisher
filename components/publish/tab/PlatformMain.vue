...
<template>
  <el-tabs v-if="tabCountStore.tabCount > 0" type="border-card" @tab-change="mainTabChange">
    <!-- Github -->
    <el-tab-pane :label="$t('main.publish.to.vuepress')" v-if="vuepressEnabled">
      <vuepress-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.hugo')" v-if="hugoEnabled">
      <hugo-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.hexo')" v-if="hexoEnabled">
      <hexo-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.jekyll')" v-if="jekyllEnabled">
      <jekyll-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>

    <!-- Metaweblog API -->
    <el-tab-pane :label="$t('main.publish.to.jvue')" v-if="jvueEnabled">
      <j-vue-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.conf')" v-if="confEnabled">
      <confluence-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.cnblogs')" v-if="cnblogsEnabled">
      <cnblogs-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>

    <!-- Wordpress -->
    <el-tab-pane :label="$t('main.publish.to.wordpress')" v-if="wordpressEnabled">
      <wordpress-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>

    <!-- Common API -->
    <el-tab-pane :label="$t('main.publish.to.liandi')" v-if="liandiEnabled">
      <liandi-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.yuque')" v-if="yuqueEnabled">
      <yuque-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>
    <el-tab-pane :label="$t('main.publish.to.kms')" v-if="kmsEnabled">
      <kms-main :is-main-reload="isReloadMainTab" :is-reload="props.isReload" :page-id="props.pageId" />
    </el-tab-pane>

    <!-- 动态平台发布 -->
    <el-tab-pane v-for="gcfg in formData.githubArray" :key="gcfg.platformKey" :label="gcfg.platformName">
      <github-main
    ...
    <el-tab-pane v-for="mcfg in formData.metaweblogArray" :key="mcfg.platformKey" :label="mcfg.platformName">
      <metaweblog-main
    ...
    <el-tab-pane v-for="wcfg in formData.wordpressArray" :key="wcfg.platformKey" :label="wcfg.platformName">
      <metaweblog-main
...
import { DynamicConfig, getDynamicJsonCfg, getDynYamlConverterAdaptor } from "~/utils/platform/dynamicConfig"
