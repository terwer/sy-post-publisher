  ...
  <el-form label-width="120px" ref="formRef" :model="formData" :rules="rules" status-icon>
    ...
    <div class="github-setting-advanced" v-if="editMode">
      ...
      <el-form-item :label="$t('setting.common.home')">
        <el-input v-model="formData.home" :placeholder="$t('setting.common.tip')" />
      </el-form-item>

      <el-form-item :label="$t('setting.github.baseUrl')">
        <el-input v-model="formData.baseUrl" :placeholder="$t('setting.github.baseUrl.tip')" />
      </el-form-item>

      <el-form-item :label="$t('setting.blog.previewMdUrl')">
        <el-input v-model="formData.previewMdUrl" :placeholder="$t('setting.blog.previewMdUrl.tip')" />
      </el-form-item>

      <el-form-item :label="$t('setting.blog.previewUrl')">
        <el-input v-model="formData.previewUrl" :placeholder="$t('setting.blog.previewUrl.tip')" />
      </el-form-item>

      <el-form-item :label="$t('setting.blog.mdFilenameRule')">
        <el-input v-model="formData.mdFilenameRule" :placeholder="$t('setting.blog.mdFilenameRule.tip')" />
      </el-form-item>
    </div>
...
const logger = LogFactory.getLogger("components/publish/tab/setting/GithubSetting.vue")
