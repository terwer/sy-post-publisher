...
<template>
  <el-tabs type="border-card" v-if="tabCountStore.tabCount > 0">
    ...
    >
      <metaweblog-setting :api-type="mcfg.platformKey" :cfg="createMCfg(mcfg)" />
    </el-tab-pane>
    <el-tab-pane
...
import { DynamicConfig, getDynamicJsonCfg, getDynPostidKey, getDynSwitchKey } from "~/utils/platform/dynamicConfig"
...
const logger = LogFactory.getLogger("components/publish/tab/PlatformSetting.vue")
