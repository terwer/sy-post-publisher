  ...
  <div id="post-detail-body">
    <el-page-header :icon="ArrowLeft" title="返回" @click="onBack">
      <template #content>
        <div class="flex items-center">
          <span class="text-large font-600 mr-3" :title="props.post.title"> {{ shortTitle }} - 文章预览 </span>
        </div>
      </template>
    </el-page-header>
    ...
    <div class="post-detail-content-box">
      <div class="btn-publish">
        ...
        <el-button v-if="isNewWin" size="small" type="primary" @click="handleNewWinPublish"
          >新窗口发布到其他平台
        </el-button>
      </div>
