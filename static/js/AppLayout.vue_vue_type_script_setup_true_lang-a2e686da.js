  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [createBaseVNode("div", _hoisted_1$1, [createBaseVNode("div", null, [createBaseVNode("span", _hoisted_2$1, " \xA92011-" + toDisplayString(unref(nowYear)()), 1), createBaseVNode("span", {
        ...
        title: _ctx.$t("service.tab.change.local")
      }, {
...
export {
  ...
  copyToClipboardInBrowser as a0,
  YamlConvertAdaptor as a1,
  reloadPage as a2,
  parseHtml as a3,
  formatNumToZhDate as a4,
  cutWords as a5,
  jiebaToHotWords as a6,
  getApiParams as a7,
  PageEditMode as a8,
  SourceContentShowType as a9,
  removeMdWidgetTag as aa,
  removeMdH1 as ab,
  yaml2Obj as ac,
  YamlFormatObj as ad,
  getPublishStatus as ae,
  PostForm as af,
  upperFirst as ag,
  VuepressYamlConvertAdaptor as ah,
  HugoYamlConverterAdaptor as ai,
  HexoYamlConverterAdaptor as aj,
  JekyllYamlConverterAdaptor as ak,
  mdToPlainText as al,
  setConf as am,
  calcLastSeconds as an,
  getDynYamlConverterAdaptor as ao,
  _sfc_main$3 as ap,
  parseJSONObj as aq,
  getSiyuanNewWinDataDir as ar,
  isFileExist as as,
  toJSONString as at,
  getPageUrl as au,
  sendChromeMessage as av,
  isLocalhost as aw,
  getPageId as b,
