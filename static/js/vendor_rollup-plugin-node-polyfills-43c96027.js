import { a as getAugmentedNamespace } from "./vendor_before-after-hook-6380be1a.js";
...
function debuglog(set) {
  if (isUndefined(debugEnviron))
    debugEnviron = { "VITE_LOG_INFO_ENABLED": "true", "VITE_DEBUG_MODE": "false", "VITE_MIDDLEWARE_URL": "https://api.terwer.space/api/middleware" }.NODE_DEBUG || "";
  set = set.toUpperCase();
  if (!debugs[set]) {
