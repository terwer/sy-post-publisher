import { l as ElPageHeader, a as ElButton, m as ElAutocomplete, n as ElTableColumn, o as ElTable, p as ElPagination, k as ElAlert, h as ElMessageBox, q as ElMain, r as ElContainer } from "./vendor_element-plus-378ccace.js";
import { u as useI18n } from "./vendor_vue-i18n-951bfa8c.js";
import { d as getByLength, e as getPublishCfg, f as parseBoolean, h as goToPage, j as _export_sfc, L as LogFactory, k as inSiyuan, i as isInSiyuanNewWinBrowser, b as getPageId, l as isEmptyString, r as removeTitleNumber, C as CONSTANTS, m as mdToHtml, n as formatIsoToZhDate } from "./AppLayout.vue_vue_type_script_setup_true_lang-d3a631b8.js";
import { P as Post, S as SiYuanApiAdaptor } from "./api-a5ab0d44.js";
import { _ as _sfc_main$6 } from "./PostDetailService.vue_vue_type_style_index_0_lang-d1b9582f.js";
import { M as defineComponent, u as ref, A as onMounted, O as openBlock, P as createElementBlock, a1 as createVNode, U as withCtx, W as createBaseVNode, $ as toDisplayString, y as unref, aD as arrow_left_default, _ as createTextVNode, T as createBlock, Z as createCommentVNode, aM as resolveComponent, bT as pushScopeId, bU as popScopeId } from "./vendor-037de53c.js";
import { P as PublishService } from "./PublishService-d5154b92.js";
import { A as AnkiIndex } from "./AnkiIndex-bd14eda6.js";
import { _ as _sfc_main$7 } from "./PicgoIndex.vue_vue_type_style_index_0_lang-534c9615.js";
const _hoisted_1$5 = {
  id: "post-detail-body"
};
const _hoisted_2$4 = {
...
const _withScopeId = (n) => (pushScopeId("data-v-bc2eafd7"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
  id: "post-list"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [showHome.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [createVNode(_component_el_autocomplete, {
        ...
        onOnChange: emitBackFn
      }, null, 8, ["publish-data"])])) : createCommentVNode("", true), showAnki.value ? (openBlock(), createElementBlock("div", _hoisted_11, [createVNode(SingleAnki, {
        post: postDetail.value,
        onOnChange: emitBackFn
      }, null, 8, ["post"])])) : createCommentVNode("", true), showPicgo.value ? (openBlock(), createElementBlock("div", _hoisted_12, [createVNode(SinglePicgo, {
        post: postDetail.value,
        onOnChange: emitBackFn
...
const BlogMain_vue_vue_type_style_index_1_scoped_bc2eafd7_lang = "";
const BlogMain = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bc2eafd7"]]);
const _hoisted_1 = {
  class: "common-layout"
};
