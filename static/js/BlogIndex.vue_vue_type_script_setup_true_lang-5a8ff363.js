...
const SingleBlogDetail_vue_vue_type_style_index_0_scoped_936adc5d_lang = "";
const SingleBlogDetail = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-936adc5d"]]);
const _hoisted_1$4 = {
  id: "publish-body"
};
const _hoisted_2$3 = {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [showHome.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [createBaseVNode("div", _hoisted_2, [createVNode(_component_el_autocomplete, {
        ...
        default: withCtx(() => [createVNode(_component_el_table_column, {
          ...
          default: withCtx((scope) => [createVNode(_component_el_tooltip, {
