...
import { L as LogFactory, S as SiYuanApi, A as API_TYPE_CONSTANTS, o as appendStr, e as getPublishCfg, r as removeTitleNumber, q as renderHTML, s as removeWidgetTag, t as removeH1, l as isEmptyString, u as getJSONConf, v as pathJoin, w as sendChromeMessage, x as getEnvOrDefault, g as getWidgetId, c as isInChromeExtension, y as isBrowser, z as SubPlatformType, B as isEmptyObject, P as PlatformType } from "./AppLayout.vue_vue_type_script_setup_true_lang-d3a631b8.js";
import { bV as Octokit } from "./vendor-037de53c.js";
import { g as gBase64 } from "./vendor_js-base64-904ab953.js";
import { f as fxp } from "./vendor_fast-xml-parser-512675b8.js";
import { s as serializeMethodCall, x as xmlrpc$1 } from "./vendor_xmlrpc-bd2abe58.js";
...
const Serializer = _vite_plugin_require_transform_serializer;
const {
  XMLParser
} = fxp;
const options = {
...
async function methodCallDirectNode(client, methodName, params) {
...
class CustomMetaWeblogApi {
  ...
  parsePost(postStruct) {
    ...
    const pcats = [];
    const cats = ((_c = (_b = (_a = this.parseFieldValue(postObj, "categories")) == null ? void 0 : _a.array) == null ? void 0 : _b.data) == null ? void 0 : _c.value) || [];
