import { g as global$1 } from "./vendor_rollup-plugin-node-polyfills-97f570f9.js";
import { g as getUserAgent } from "./vendor_universal-user-agent-ef49518b.js";
...
function renderComponentRoot(instance) {
  const { type: Component, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit, render: render3, renderCache, data, setupState, ctx, inheritAttrs } = instance;
  let result;
...
function useEventListener(...args) {
  ...
  const register = (el, event, listener3) => {
    el.addEventListener(event, listener3, options);
    return () => el.removeEventListener(event, listener3, options);
  };
  const stopWatch = watch(() => unrefElement(target), (el) => {
    ...
    cleanups.push(...events.flatMap((event) => {
      return listeners.map((listener3) => register(el, event, listener3));
    }));
  ...
  const cleanup = [
    ...
    useEventListener(window2, "pointerup", (e) => {
      if (e.button === 0) {
        ...
        e.composedPath = () => path;
        fallback = window2.setTimeout(() => listener3(e), 50);
      }
    }, { passive: true }),
...
export {
  ...
  triggerRef as aK,
  toRawType as aL,
  resolveComponent as aM,
  resolveDirective as aN,
  vModelText as aO,
  more_filled_default as aP,
  picture_filled_default as aQ,
  normalizeProps as aR,
  isPromise as aS,
  useDocumentVisibility as aT,
  useWindowFocus as aU,
  plus_default as aV,
  computedEager as aW,
  caret_right_default as aX,
  shallowReactive as aY,
  render$1 as aZ,
  effectScope as a_,
  normalizeStyle as aa,
  useEventListener as ab,
  reactive as ac,
  onUpdated as ad,
  cloneVNode as ae,
  Text as af,
  ...
  useDark as b$,
  isReactive as b0,
  getCurrentScope as b1,
  CoreWarnCodes as b2,
  CompileErrorCodes as b3,
  makeSymbol as b4,
  assign as b5,
  isNumber$1 as b6,
  isString$1 as b7,
  isObject as b8,
  NUMBER_FORMAT_OPTIONS_KEYS as b9,
  MISSING_RESOLVE_VALUE as bA,
  parseDateTimeArgs as bB,
  datetime as bC,
  parseNumberArgs as bD,
  number as bE,
  setFallbackContext as bF,
  library$1 as bG,
  faUpload as bH,
  faBookOpenReader as bI,
  faRectangleList as bJ,
  faXmark as bK,
  faCircleXmark as bL,
  faBolt as bM,
  faCreditCard as bN,
  ...
  faFileLines as bS,
  faDownload as bT,
  faMagnifyingGlass as bU,
  faPaste as bV,
  faFileImport as bW,
  faGear as bX,
  faArrowRotateRight as bY,
  FontAwesomeIcon as bZ,
  createApp as b_,
  DATETIME_FORMAT_OPTIONS_KEYS as ba,
  isBoolean$1 as bb,
  registerMessageResolver as bc,
  registerLocaleFallbacker as bd,
  getGlobalThis as be,
  setDevToolsHook as bf,
  createCompileError as bg,
  DEFAULT_LOCALE as bh,
  isArray as bi,
  isPlainObject as bj,
  isRegExp as bk,
  isFunction$1 as bl,
  updateFallbackLocale as bm,
  inBrowser as bn,
  resolveValue as bo,
  fallbackWithLocaleChain as bp,
  hasOwn as bq,
  createCoreContext as br,
  clearDateTimeFormat as bs,
  clearNumberFormat as bt,
  isEmptyObject as bu,
  setAdditionalMeta as bv,
  getFallbackContext as bw,
  NOT_REOSLVED as bx,
  parseTranslateArgs as by,
  translate as bz,
  capitalize$1 as c,
  useToggle as c0,
  pushScopeId as c1,
